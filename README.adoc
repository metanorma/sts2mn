...
[source,sh]
----
java -jar target/sts2mn-1.3.jar <XML-FileName>
----

[source,sh]
----
java -jar target/sts2mn-1.3.jar --format adoc <XML-FileName>
----

[source,sh]
----
java -jar target/sts2mn-1.3.jar --format adoc <XML-FileName> --output <ADOC-FileName>
----

[source,sh]
----
java -jar target/sts2mn-1.3.jar --format xml <XML-FileName>
----

[source,sh]
----
java -jar target/sts2mn-1.3.jar --format xml <XML-FileName> --output <XML-FileName>
----

[source,sh]
----
java -jar target/sts2mn-1.3.jar --split-bibdata <XML-FileName>
----
...
[source,sh]
----
java -jar target/sts2mn-1.3.jar C070907e.xml
----
